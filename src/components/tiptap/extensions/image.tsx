          ...
          >
            ...
            <DropdownMenu open={openedMore} onOpenChange={setOpenedMore}>
              <DropdownMenuTrigger asChild>
                <Button size='small' className='size-7' intent='ghost'>
              ...
              >
                <DropdownMenuItem onClick={() => setEditingCaption(true)}>
                  <Edit className='mr-2 size-4' /> Редактировать подпись
                </DropdownMenuItem>
                <DropdownMenuSub>
                  <DropdownMenuSubTrigger>
                    <ImageIcon className='mr-2 size-4' /> Поменять изображение
                  </DropdownMenuSubTrigger>
                ...
                >
                  <Maximize className='mr-2 size-4' /> Во всю длину
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  ...
                  onClick={deleteNode}
                >
                  <Trash className='mr-2 size-4' /> Удалить изображение
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
