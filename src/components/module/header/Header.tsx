...
const Header: React.FC = () => {
  return (
    <header className='absolute min-h-screen md:static md:min-h-auto'>
      <Container className='shadow-top border-secondary bg-background fixed bottom-1 left-0 z-50 ml-[1%] flex max-w-[98%] items-center justify-evenly gap-2.5 overflow-hidden rounded-2xl border-1 border-solid md:top-0 md:left-1/2 md:mx-auto md:w-auto md:w-full md:max-w-[1320px] md:-translate-x-1/2 md:justify-between md:gap-2 md:self-start md:rounded-none md:border-none md:bg-transparent md:py-3 md:shadow-none'>
        <Logotype />
        <Navigation />
