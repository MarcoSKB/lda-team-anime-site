      ...
      <>
        ...
        >
          <div id={triggerDescriptionId} className='sr-only'>
            Выпадающий список с несколькими вариантами выбора. Используйте
            клавиши со стрелками для навигации, Enter для выбора и Escape для
            закрытия.
          </div>
          <div id={selectedCountId} className='sr-only' aria-live='polite'>
            {selectedValues.length === 0
              ...
              : `${selectedValues.length} ${
                  selectedValues.length === 1 ? 'параметр' : 'параметров'
                } ${
                  selectedValues.length === 1 ? 'выбран' : 'выбраны'
                }: ${selectedValues
            ...
            <Command>
              ...
              {searchable && (
                <div id={`${multiSelectId}-search-help`} className='sr-only'>
                  Введите, чтобы отфильтровать параметры. Используйте клавиши со
                  стрелками для навигации по результатам.
                </div>
              )}
              <CommandList
                className={cn(
              ...
              >
                <CommandEmpty>
                  {emptyIndicator || 'Результатов не найдено.'}
                </CommandEmpty>{' '}
                    ...
                    >
                      ...
                      <span>
                        ...
                        {getAllOptions().length > 20
                          ? ` - ${getAllOptions().length} параметров`
                          : ''}
                        )
                      </span>
                    </CommandItem>
